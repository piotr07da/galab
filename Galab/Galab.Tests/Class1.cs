...
namespace Galab.Tests
{
    public class Class1
    {
        ...
        public async Task test_cosmos_db()
        {
            ...
            var c = new CosmosClient("AccountEndpoint=https://localhost:8082/;AccountKey=C2y6yDjf5/R+ob0N8A7Cgv30VRDJIWEHLM+4QDU5DE2nQ9nDuVTqobD4b8mGGyPMbIZnqyMsEcaGQy67XIw/Jw==", clientOptions);
